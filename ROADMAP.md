...
- [ ] 24-month backfill; DynamoDB online-feature layer; time-travel queries; the production `GlueIcebergFeatureStore` read client (Phase 6); `causal_utilization`/`wash_rate` deferred (unused in v1)
