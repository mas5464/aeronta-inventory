...
- [ ] **React follow-ups (remaining):** routing/tabs; full WCAG audit; bulk-approve `types` filter + per-result detail; history view for already-approved rows (selection is queue-bound today)
