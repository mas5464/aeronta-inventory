...
- [ ] **React follow-ups (remaining):** detail right-drawer (currently below the table); bulk per-result detail; detail-pane URL routes; richer color-contrast/AAA audit
