...
- [ ] Online-table population orchestration (nightly Glue + event lane); 24-month backfill; time-travel queries; `causal_utilization`/`wash_rate` deferred (unused in v1)
