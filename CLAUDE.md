...
| `apps/planner-ui` (React/TS — first frontend) | `cd apps/planner-ui && npm install && npm test` (Vitest, 55 tests); `npm run build` (tsc + vite) | `tsc -b` (no ruff — JS/TS) |
