...
/** The primary key class for the REQUISITION_DETAIL_AUDIT database table. */
@Setter
@Getter
@Embeddable
public class RequisitionDetailAuditPK implements Serializable {
    ...
    public RequisitionDetailAuditPK() {}

    public boolean equals(Object other) {
        if (this == other) {
            return true;
        }
        if (!(other instanceof RequisitionDetailAuditPK castOther)) {
            return false;
        }
